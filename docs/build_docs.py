...
def build_readme(A, figs) -> str:
    ...
    parts.append(
        ...
        "**New here? Start with the 2-Minute Judge Demo** — the first page in the sidebar. It "
        "tells the whole story through one attack, in plain language: a synthetic scam evades the "
        "current detector, the system learns from it, and genuine customers stay protected — with "
        "every number read from a committed artifact and the technical detail one click away.\n\n"
        "### Other commands\n\n"
        ...
        "| `python -m src.experiments.judge_hero` | Regenerate the Judge Demo hero transaction "
        "from the committed loop models | seconds |\n"
